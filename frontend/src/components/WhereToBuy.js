        ...
        <div className="max-w-md mx-auto">
          {config.exchanges.map((exchange, index) => (
            <a
              ...
              className="block bg-gray-800 hover:bg-gray-700 rounded-lg p-8 mb-6 transition-all duration-300 transform hover:scale-105 hover:shadow-xl border border-gray-700 hover:border-crypto-gold"
            >
